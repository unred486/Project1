...
DOUBLE PRECISION :: XXZ(600),ZGIVEN(600)
...
double precision :: XNEW(NMAX),C(*),SS(NATJ,NMAX),X(JJ),DMIX(400),DM(NMAX) &
    ,XOLD(NMAX)
double precision :: XST,ZST,XSTR,XEND
integer :: IPAR(*)
integer :: IRMAX,IREFINE,JJ,J,NMAX,NATJ,JOLD
