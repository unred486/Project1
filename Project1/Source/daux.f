*DECK d2mach
      DOUBLE PRECISION FUNCTION d2mach (IDUMMY)
C***BEGIN PROLOGUE  d2mach
C***PURPOSE  Compute the unit roundoff of the machine.
C***CATEGORY  R1
C***TYPE      DOUBLE PRECISION (R1MACH-S, d2mach-D)
C***KEYWORDS  MACHINE CONSTANTS
C***AUTHOR  Hindmarsh, Alan C., (LLNL)
C***DESCRIPTION
C *Usage:
C        DOUBLE PRECISION  A, d2mach
C        A = d2mach(idummy)  [The argument is ignored.]
C
...
C     number u such that  1.0 + u .ne. 1.0.  This is computed by d2mach
...
C***END PROLOGUE  d2mach
C
      INTEGER IDUMMY
      DOUBLE PRECISION U, COMP
C***FIRST EXECUTABLE STATEMENT  d2mach
      U = 1.0D0
 10   U = U*0.5D0
      ...
      d2mach = U*2.0D0
      RETURN
C----------------------- End of Function d2mach ------------------------
      END
      SUBROUTINE DUMSUM(A,B,C)
C     Routine to force normal storing of A + B, for d2mach.
